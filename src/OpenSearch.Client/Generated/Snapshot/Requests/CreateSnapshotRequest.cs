...
public sealed class CreateSnapshotEndpoint : IEndpoint<CreateSnapshotRequest, CreateSnapshotResponse>
{
	public static readonly CreateSnapshotEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(CreateSnapshotRequest r) => OpenSearch.Net.HttpMethod.Put;

	public string RequestUrl(CreateSnapshotRequest r)
	{
	...
	public RequestBody? GetBody(CreateSnapshotRequest r) => RequestBody.Json(r);

	public CreateSnapshotResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<CreateSnapshotResponse>(body)!;
}
