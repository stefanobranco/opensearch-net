...
public sealed class PutComponentTemplateClusterRequest
{
...
public sealed class PutComponentTemplateClusterEndpoint : IEndpoint<PutComponentTemplateClusterRequest, PutComponentTemplateClusterResponse>
{
	public static readonly PutComponentTemplateClusterEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(PutComponentTemplateClusterRequest r) => OpenSearch.Net.HttpMethod.Put;

	public string RequestUrl(PutComponentTemplateClusterRequest r)
	{
	...
	public RequestBody? GetBody(PutComponentTemplateClusterRequest r) => RequestBody.Json(r);

	public PutComponentTemplateClusterResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<PutComponentTemplateClusterResponse>(body)!;
}
