...
public sealed class GetComponentTemplateClusterRequest
{
...
public sealed class GetComponentTemplateClusterEndpoint : IEndpoint<GetComponentTemplateClusterRequest, GetComponentTemplateClusterResponse>
{
	public static readonly GetComponentTemplateClusterEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(GetComponentTemplateClusterRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(GetComponentTemplateClusterRequest r)
	{
	...
	public RequestBody? GetBody(GetComponentTemplateClusterRequest r) => null;

	public GetComponentTemplateClusterResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<GetComponentTemplateClusterResponse>(body)!;
}
