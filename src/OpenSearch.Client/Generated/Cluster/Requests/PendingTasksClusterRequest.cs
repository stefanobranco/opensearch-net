...
public sealed class PendingTasksClusterRequest
{
...
public sealed class PendingTasksClusterEndpoint : IEndpoint<PendingTasksClusterRequest, PendingTasksClusterResponse>
{
	public static readonly PendingTasksClusterEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(PendingTasksClusterRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(PendingTasksClusterRequest r)
	{
	...
	public RequestBody? GetBody(PendingTasksClusterRequest r) => null;

	public PendingTasksClusterResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<PendingTasksClusterResponse>(body)!;
}
