...
public sealed class StateClusterRequest
{
...
public sealed class StateClusterEndpoint : IEndpoint<StateClusterRequest, StateClusterResponse>
{
	public static readonly StateClusterEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(StateClusterRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(StateClusterRequest r) => null;

	public StateClusterResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<StateClusterResponse>(body)!;
}
