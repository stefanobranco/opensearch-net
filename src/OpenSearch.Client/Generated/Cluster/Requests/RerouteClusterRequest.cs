...
public sealed class RerouteClusterRequest
{
...
public sealed class RerouteClusterEndpoint : IEndpoint<RerouteClusterRequest, RerouteClusterResponse>
{
	public static readonly RerouteClusterEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(RerouteClusterRequest r) => OpenSearch.Net.HttpMethod.Post;

	public string RequestUrl(RerouteClusterRequest r)
	{
		...
		if (r.Metric is not null)
			queryParts.Add($"metric={Uri.EscapeDataString(string.Join(",", r.Metric!))}");
	...
	public RequestBody? GetBody(RerouteClusterRequest r) => RequestBody.Json(r);

	public RerouteClusterResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<RerouteClusterResponse>(body)!;
}
