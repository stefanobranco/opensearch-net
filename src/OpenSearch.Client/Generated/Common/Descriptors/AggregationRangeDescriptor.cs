...
public sealed class AggregationRangeDescriptor
{
	...
	/// <summary>Start of the range (inclusive).</summary>
		public AggregationRangeDescriptor From(double? value) { _value.From = value; return this; }
	...
	/// <summary>End of the range (exclusive).</summary>
		public AggregationRangeDescriptor To(double? value) { _value.To = value; return this; }
