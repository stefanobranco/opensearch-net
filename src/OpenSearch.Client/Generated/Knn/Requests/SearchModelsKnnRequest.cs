...
public sealed class SearchModelsKnnRequest
{
...
public sealed class SearchModelsKnnEndpoint : IEndpoint<SearchModelsKnnRequest, SearchModelsKnnResponse>
{
	public static readonly SearchModelsKnnEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(SearchModelsKnnRequest r) => OpenSearch.Net.HttpMethod.Post;

	public string RequestUrl(SearchModelsKnnRequest r)
	{
	...
	public RequestBody? GetBody(SearchModelsKnnRequest r) => r.Body is not null ? RequestBody.Json(r.Body) : null;

	public SearchModelsKnnResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<SearchModelsKnnResponse>(body)!;
}
