...
public sealed class NodeattrsCatRequest
{
...
public sealed class NodeattrsCatEndpoint : IEndpoint<NodeattrsCatRequest, NodeattrsCatResponse>
{
	public static readonly NodeattrsCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(NodeattrsCatRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(NodeattrsCatRequest r)
	{
