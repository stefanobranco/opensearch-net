...
public sealed class RecoveryCatRequest
{
...
public sealed class RecoveryCatEndpoint : IEndpoint<RecoveryCatRequest, RecoveryCatResponse>
{
	public static readonly RecoveryCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(RecoveryCatRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(RecoveryCatRequest r) => null;

	public RecoveryCatResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<RecoveryCatResponse>(body)!;
}
