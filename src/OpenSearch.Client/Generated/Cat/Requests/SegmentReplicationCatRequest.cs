...
public sealed class SegmentReplicationCatRequest
{
...
public sealed class SegmentReplicationCatEndpoint : IEndpoint<SegmentReplicationCatRequest, SegmentReplicationCatResponse>
{
	public static readonly SegmentReplicationCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(SegmentReplicationCatRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(SegmentReplicationCatRequest r) => null;

	public SegmentReplicationCatResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<SegmentReplicationCatResponse>(body)!;
}
