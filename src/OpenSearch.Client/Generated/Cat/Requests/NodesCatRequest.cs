...
public sealed class NodesCatRequest
{
...
public sealed class NodesCatEndpoint : IEndpoint<NodesCatRequest, NodesCatResponse>
{
	public static readonly NodesCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(NodesCatRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(NodesCatRequest r)
	{
		var path = $"/_cat/nodes";
