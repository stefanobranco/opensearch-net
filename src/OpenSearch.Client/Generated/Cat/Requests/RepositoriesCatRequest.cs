...
public sealed class RepositoriesCatRequest
{
...
public sealed class RepositoriesCatEndpoint : IEndpoint<RepositoriesCatRequest, RepositoriesCatResponse>
{
	public static readonly RepositoriesCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(RepositoriesCatRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(RepositoriesCatRequest r)
	{
