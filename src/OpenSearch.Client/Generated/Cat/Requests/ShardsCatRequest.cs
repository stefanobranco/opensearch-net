...
public sealed class ShardsCatRequest
{
	/// <summary></summary>
	[JsonIgnore]
...
public sealed class ShardsCatEndpoint : IEndpoint<ShardsCatRequest, ShardsCatResponse>
{
	public static readonly ShardsCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(ShardsCatRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(ShardsCatRequest r) => null;

	public ShardsCatResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<ShardsCatResponse>(body)!;
}
