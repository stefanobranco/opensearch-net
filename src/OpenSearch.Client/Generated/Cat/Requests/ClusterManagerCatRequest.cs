...
public sealed class ClusterManagerCatRequest
{
...
public sealed class ClusterManagerCatEndpoint : IEndpoint<ClusterManagerCatRequest, ClusterManagerCatResponse>
{
	public static readonly ClusterManagerCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(ClusterManagerCatRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(ClusterManagerCatRequest r)
	{
	...
	public RequestBody? GetBody(ClusterManagerCatRequest r) => null;

	public ClusterManagerCatResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<ClusterManagerCatResponse>(body)!;
}
