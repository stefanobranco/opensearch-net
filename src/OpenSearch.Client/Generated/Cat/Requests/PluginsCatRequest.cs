...
public sealed class PluginsCatRequest
{
...
public sealed class PluginsCatEndpoint : IEndpoint<PluginsCatRequest, PluginsCatResponse>
{
	public static readonly PluginsCatEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(PluginsCatRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(PluginsCatRequest r)
	{
