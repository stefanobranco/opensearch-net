...
public sealed class UpgradeIndexRequest
{
...
public sealed class UpgradeIndexEndpoint : IEndpoint<UpgradeIndexRequest, UpgradeIndexResponse>
{
	public static readonly UpgradeIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(UpgradeIndexRequest r) => OpenSearch.Net.HttpMethod.Post;

	public string RequestUrl(UpgradeIndexRequest r)
	{
	...
	public RequestBody? GetBody(UpgradeIndexRequest r) => null;

	public UpgradeIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<UpgradeIndexResponse>(body)!;
}
