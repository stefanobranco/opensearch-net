...
public sealed class GetSettingsIndexRequest
{
...
public sealed class GetSettingsIndexEndpoint : IEndpoint<GetSettingsIndexRequest, GetSettingsIndexResponse>
{
	public static readonly GetSettingsIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(GetSettingsIndexRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(GetSettingsIndexRequest r) => null;

	public GetSettingsIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<GetSettingsIndexResponse>(body)!;
}
