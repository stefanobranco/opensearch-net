...
public sealed class ValidateQueryRequest
{
...
public sealed class ValidateQueryEndpoint : IEndpoint<ValidateQueryRequest, ValidateQueryResponse>
{
	...
	public OpenSearch.Net.HttpMethod Method(ValidateQueryRequest r) => OpenSearch.Net.HttpMethod.Post;

	public string RequestUrl(ValidateQueryRequest r)
	{
