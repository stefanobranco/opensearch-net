...
public sealed class GetFieldMappingIndexRequest
{
...
public sealed class GetFieldMappingIndexEndpoint : IEndpoint<GetFieldMappingIndexRequest, GetFieldMappingIndexResponse>
{
	public static readonly GetFieldMappingIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(GetFieldMappingIndexRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(GetFieldMappingIndexRequest r) => null;

	public GetFieldMappingIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<GetFieldMappingIndexResponse>(body)!;
}
