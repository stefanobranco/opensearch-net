...
public sealed class SegmentsIndexRequest
{
...
public sealed class SegmentsIndexEndpoint : IEndpoint<SegmentsIndexRequest, SegmentsIndexResponse>
{
	public static readonly SegmentsIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(SegmentsIndexRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(SegmentsIndexRequest r) => null;

	public SegmentsIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<SegmentsIndexResponse>(body)!;
}
