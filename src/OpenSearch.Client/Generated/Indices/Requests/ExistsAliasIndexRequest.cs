...
public sealed class ExistsAliasIndexRequest
{
...
public sealed class ExistsAliasIndexEndpoint : IEndpoint<ExistsAliasIndexRequest, ExistsAliasIndexResponse>
{
	public static readonly ExistsAliasIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(ExistsAliasIndexRequest r) => OpenSearch.Net.HttpMethod.Head;
	...
	public RequestBody? GetBody(ExistsAliasIndexRequest r) => null;

	public ExistsAliasIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
