...
public sealed class PutSettingsIndexRequest
{
...
public sealed class PutSettingsIndexEndpoint : IEndpoint<PutSettingsIndexRequest, PutSettingsIndexResponse>
{
	public static readonly PutSettingsIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(PutSettingsIndexRequest r) => OpenSearch.Net.HttpMethod.Put;
	...
	public RequestBody? GetBody(PutSettingsIndexRequest r) => RequestBody.Json(r);

	public PutSettingsIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<PutSettingsIndexResponse>(body)!;
}
