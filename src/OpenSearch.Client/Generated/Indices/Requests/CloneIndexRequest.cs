...
public sealed class CloneIndexRequest
{
...
public sealed class CloneIndexEndpoint : IEndpoint<CloneIndexRequest, CloneIndexResponse>
{
	public static readonly CloneIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(CloneIndexRequest r) => OpenSearch.Net.HttpMethod.Put;

	public string RequestUrl(CloneIndexRequest r)
	{
	...
	public RequestBody? GetBody(CloneIndexRequest r) => RequestBody.Json(r);

	public CloneIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<CloneIndexResponse>(body)!;
}
