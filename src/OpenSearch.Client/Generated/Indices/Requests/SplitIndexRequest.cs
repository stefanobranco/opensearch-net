...
public sealed class SplitIndexRequest
{
...
public sealed class SplitIndexEndpoint : IEndpoint<SplitIndexRequest, SplitIndexResponse>
{
	public static readonly SplitIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(SplitIndexRequest r) => OpenSearch.Net.HttpMethod.Put;

	public string RequestUrl(SplitIndexRequest r)
	{
		var path = $"/{Uri.EscapeDataString(r.Index!.ToString()!)}/_split/{Uri.EscapeDataString(r.Target!.ToString()!)}";
	...
	public RequestBody? GetBody(SplitIndexRequest r) => RequestBody.Json(r);

	public SplitIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<SplitIndexResponse>(body)!;
}
