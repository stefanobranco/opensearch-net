...
public sealed class GetAliasRequest
{
...
public sealed class GetAliasEndpoint : IEndpoint<GetAliasRequest, GetAliasResponse>
{
	...
	public OpenSearch.Net.HttpMethod Method(GetAliasRequest r) => OpenSearch.Net.HttpMethod.Get;

	public string RequestUrl(GetAliasRequest r)
	{
