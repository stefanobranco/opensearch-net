...
public sealed class OpenIndexRequest
{
...
public sealed class OpenIndexEndpoint : IEndpoint<OpenIndexRequest, OpenIndexResponse>
{
	public static readonly OpenIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(OpenIndexRequest r) => OpenSearch.Net.HttpMethod.Post;
	...
	public RequestBody? GetBody(OpenIndexRequest r) => null;

	public OpenIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<OpenIndexResponse>(body)!;
}
