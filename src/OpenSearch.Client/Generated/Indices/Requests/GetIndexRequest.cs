...
public sealed class GetIndexEndpoint : IEndpoint<GetIndexRequest, GetIndexResponse>
{
	public static readonly GetIndexEndpoint Instance = new();

	public OpenSearch.Net.HttpMethod Method(GetIndexRequest r) => OpenSearch.Net.HttpMethod.Get;
	...
	public RequestBody? GetBody(GetIndexRequest r) => null;

	public GetIndexResponse DeserializeResponse(int statusCode, string? contentType, Stream body, IOpenSearchSerializer serializer) =>
		serializer.Deserialize<GetIndexResponse>(body)!;
}
